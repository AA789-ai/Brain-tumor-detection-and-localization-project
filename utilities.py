...
class DataGenerator(tf.keras.utils.Sequence):
  def __init__(self, ids , mask, image_dir = './Healthcare AI Datasets/Brain_MRI/', batch_size = 16, img_h = 256, img_w = 256, shuffle = True):
  ...
  def __data_generation(self, list_ids, list_mask):
    ...
    for i in range(len(list_ids)):
      #path of the image
      img_path = './Healthcare AI Datasets/Brain_MRI/' + str(list_ids[i])
      
      #mask path
      mask_path = './Healthcare AI Datasets/Brain_MRI/' + str(list_mask[i])
